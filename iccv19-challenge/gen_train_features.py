...
def main(args):
  ...
  # features_all = np.zeros((100, 512), dtype=np.float32)
  # features_all_flip = np.zeros((100, 512), dtype=np.float32)
  ...
  print("save features ...")
  features_all.tofile('train_features')
  print("save train_features_flip ...")
  features_all_flip.tofile('train_features_flip')
...
def parse_arguments(argv):
  ...
  parser.add_argument('--model', type=str, help='', default='/home/gaomingda/insightface/iccv19-challenge/gen_train_features/res101/model,1')
