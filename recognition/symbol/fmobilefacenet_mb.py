...
def body(data, blocks, namespace=""):
    blocks = blocks
...
def get_symbol():
    ...
    conv_6_sep = body(data, config.net_blocks)
    ...
    conv_6_sep2 = body(data2, [1,4,8,2],namespace="crop")
    ...
    conv_6_f = symbol_utils.Linear(data=conv6_dw, num_filter=num_classes, name='pre_fc1')
