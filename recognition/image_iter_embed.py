...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul  6 10:26:26 2019
...
class FaceImageIter(io.DataIter):
    ...
    def __init__(self, batch_size, data_shape,
      ...
      #  self.train_features = open('../datasets/ms1m-retinaface-t1/train_features','r').readlines()
        ...
        train_features = np.fromfile('../datasets/ms1m-retinaface-t1/train_features_oct200', dtype=np.float32)
        self.train_features = train_features.reshape(5179510, config.emb_size)
        train_features_flip = np.fromfile('../datasets/ms1m-retinaface-t1/train_features_flip_oct200', dtype=np.float32)
    ...
    def next_sample(self):
        ...
        if self.seq is not None:
          while True:
            ...
            embed = self.train_features[idx-1]
            embed_flip = self.train_features_flip[idx-1]
